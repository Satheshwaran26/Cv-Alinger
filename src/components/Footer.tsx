      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            ...
            {/* LinkedIn Button */}
            <a className="libutton" href="https://www.linkedin.com/in/brittytino" target="_blank" rel="noopener noreferrer">
              Follow on LinkedIn
            </a>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-muted/30 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex flex-col md:flex-row items-center gap-2 md:gap-6 text-sm">
            <div className="text-primary font-medium">
              <a href="https://www.linkedin.com/in/brittytino/" target="_blank" rel="noopener noreferrer" className="hover:underline flex items-center gap-1">
