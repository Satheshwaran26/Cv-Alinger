export const posts = {
  ...
  'resume-ai-career-changers': {
    ...
    date: 'October 5, 2024',
    author: 'Hanan Amos',
    categories: ['Resume Tips', 'Career Advice', 'AI Tools'],
    content: `
      <h1 class="text-3xl md:text-4xl font-bold mb-6 text-slate-900 dark:text-white">Resume AI for Career Changers: Highlighting Transferable Skills</h1>
      ...
      <ul class="list-disc pl-6 mb-4">
        ...
        <li class-1">Resource allocation</li>
      ...
      <ul class="list-disc pl-6 mb-4">
        ...
        <li class="mb-1">Reducing industry-specific jargon from your previous sector</li>
